#!/usr/bin/env python3
"""This script contains all of the modules used in resize_data.py"""

from raspberry_pi_libraries import multi_wrapper

class ResizeData(multi_wrapper.Packages):
    """Class that adapts parent's modules for ResizeData"""
    class InitBashArgs(multi_wrapper.Packages.InitBashArgs):
        ...
        def get_arg_params(cls):
            ...
            cls._parser.add_argument("--input-dir", default=None, type=str,
                                     help="directory from which data will be resized")
            cls._parser.add_argument("--output-dir", default=None, type=str,
                                     help="directory at which resized data will be saved")
            cls._parser.add_argument("--new-size", default=300, type=int,
                                     help="side length to be resized to")
