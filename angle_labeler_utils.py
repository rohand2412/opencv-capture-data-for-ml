#!/usr/bin/env python3
"""This script contains all of the modules used in angle_labeler.py"""

from raspberry_pi_libraries import multi_wrapper

class AngleLabeler(multi_wrapper.Packages):
    """Class that adapts parent's modules for AngleLabeler"""
